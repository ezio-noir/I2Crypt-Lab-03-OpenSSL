...
def main():
    ...
    operation.add_argument('-pr', '--private', action='store_true', help='To read private key file.')
    operation.add_argument('-pu', '--public', action='store_true', help='To read public key file.')
